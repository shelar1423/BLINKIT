...
export const HERO_CARS: Product[] = [
  {
    ...
    views: [CAR('ballistik-diecast'), CAR('ballistik-rear'), CAR('ballistik-side'), CAR('ballistik-top')],
  ...
  },
  {
    ...
    views: [CAR('battlespec-diecast'), CAR('battlespec-rear'), CAR('battlespec-side'), CAR('battlespec-top')],
  ...
  },
  {
    ...
    views: [CAR('jackhammer-diecast'), CAR('jackhammer-rear'), CAR('jackhammer-side'), CAR('jackhammer-top')],
  ...
  },
  {
    ...
    views: [CAR('hollowback-diecast'), CAR('hollowback-rear'), CAR('hollowback-side'), CAR('hollowback-top')],
  ...
  },
  {
    ...
    views: [CAR('kitt-diecast'), CAR('kitt-rear'), CAR('kitt-side'), CAR('kitt-top')],
    glb: '/models/kitt.glb',
    badge: 'RARE',
  },
];
